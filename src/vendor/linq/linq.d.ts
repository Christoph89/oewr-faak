...
interface JQuery
{
  ...
  q(): linq.Enumerable<JQuery>;
}

declare function $q(nr: number): linq.Enumerable<number>;
declare function $q(str: string): linq.Enumerable<string>;
declare function $q<T>(arr: T[]): linq.Enumerable<T>;
declare function $q(list: NodeList): linq.Enumerable<Node>;
declare function $q(jq: JQuery): linq.Enumerable<JQuery>;
declare function $q(obj: Object): linq.Enumerable<linq.KeyValuePair<string, any>>;